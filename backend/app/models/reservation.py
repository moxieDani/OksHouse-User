...
class Reservation(Base):
    ...
    guests = Column(Integer, nullable=False, comment="인원수")
    purpose = Column(String, nullable=True, comment="목적")
    ...
    confirmed_by = Column(Integer, ForeignKey("admins.admin_id"), nullable=True, comment="확정 관리자 ID")
